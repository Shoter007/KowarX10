...
function GrowLancerSpinStep_Level1(InDamage, Dexterity)
	local OutDamage = InDamage * (Dexterity / 10 + 97) / 100.0

	return OutDamage
end

-- SkillID: 690, Harsh Strike Mastery - (Mirage Lancer)
function GrowLancerSpinStep_Level2(InDamage, Dexterity)
	local OutDamage = InDamage * (Dexterity / 10 + 97 ) / 100.0
...
function GrowLancerHarshStrike_Level1(InDamage, Strength)
	local OutDamage = InDamage * (Strength / 10 + 97 ) / 100.0

	return OutDamage
end

-- SkillID: 691, Harsh Strike Mastery - (Mirage Lancer)
function GrowLancerHarshStrike_Level2(InDamage, Strength)
	local OutDamage = InDamage * (Strength / 10 + 97 ) / 100.0
...
function GrowLancerMagicPin_Level1(InDamage, Dexterity)
	local OutDamage = InDamage * (Dexterity / 10 + 97 ) / 100.0

	return OutDamage
end

-- SkillID: 694, Magic Pin Proficiency - (Mirage Lancer)
function GrowLancerMagicPin_Level2(InDamage, Dexterity)
	local OutDamage = InDamage * (Dexterity / 10 + 97 ) / 100.0
...
function GrowLancerMagicPin_Level3(InDamage, Dexterity)
	local OutDamage = InDamage * (Dexterity / 10 + 97 ) / 100.0
...
function GrowLancerBreche_Level1(InDamage, Strength)
	local OutDamage = InDamage * (Strength / 10 + 97 ) / 100.0

	return OutDamage
end

-- SkillID: 697, Breche Proficiency - (Mirage Lancer)
function GrowLancerBreche_Level2(InDamage, Strength)
	local OutDamage = InDamage * (Strength / 10 + 97 ) / 100.0
...
function GrowLancerBreche_Level3(InDamage, Strength)
	local OutDamage = InDamage * (Strength / 10 + 97) / 100.0
...
function GrowLancerShiningPeak_Level1(InDamage, Strength, Dexterity, SkillTreeBonus_Retailation, SkillTreeBonus_Rage)
	local OutDamage = InDamage * ((Strength / 10 + 97 + SkillTreeBonus_Retailation) + (Dexterity / 10 + 97 + SkillTreeBonus_Rage)) / 100.0
...
-- SkillID: 703, Circle Shield PowUp - (Mirage Lancer)
function GrowLancerCircleShield_Level1(Strength, Dexterity, Energy)
	local SkillEffect = 10
	local SkillSuccessRate = Strength / 40
	local SkillTime = Energy / 10 + 60

	return SkillEffect, SkillSuccessRate, SkillTime
end

-- SkillID: 706, Circle Shield Mastery - (Mirage Lancer)
function GrowLancerCircleShield_Level2(Strength, Dexterity, Energy)
	local SkillEffect = 10
	local SkillSuccessRate = Strength / 40
	local SkillTime = Energy / 10 + 60
