...
function MLS_ValueInit()
	...
	AddToMLSTable(40, 'FN_LuaGetIncStat_3', MLST_VALUE_NORMAL) -- 0
	AddToMLSTable(41, 'FN_LuaGetSkillDamageMin3', MLST_VALUE_NORMAL) -- 0
	AddToMLSTable(42, 'FN_LuaGetSkillDamageMax2', MLST_VALUE_NORMAL) -- 0
end
...
-- SkillID: 40
--///////////////////////////////////////////////////////////////////////////////
function FN_LuaGetIncStat_3(nPoint)
	local nReturn = (1 + ( ( ( ( ( ( (nPoint - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12) ) * 15
	return nReturn
end
...
-- SkillID: 41
--///////////////////////////////////////////////////////////////////////////////
function FN_LuaGetSkillDamageMin3(nPoint)
	local nReturn = (1 + ((((((((nPoint) - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12)) * 10
	return nReturn
end
...
-- SkillID: 42
--///////////////////////////////////////////////////////////////////////////////
function FN_LuaGetSkillDamageMax2(nPoint)
...
-- SkillID: 43
--//////////////////////////////////////////////////////////////////////////////
function FN_LuaGetAGIncRate(nPoint)
	local nReturn = (nPoint * 0.005 + 1.0)
	return nReturn
end