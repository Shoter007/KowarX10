...
function GrowLancerSpinStep(InDamage, Dexterity)
...
function GrowLancerHarshStrike(InDamage, Strength)
...
function GrowLancerMagicPin(InDamage, Dexterity)
	local OutDamage = InDamage * (Dexterity / 10 + 97) / 100.0
...
function GrowLancerBreche(InDamage, Strength)
	local OutDamage = InDamage * (Strength / 10 + 97 ) / 100.0
...
function GrowLancerShiningPeak(InDamage, Strength, Dexterity)
	local OutDamage = InDamage * ((Strength / 10 + 97) + (Dexterity / 10 + 97)) / 100.0
...
-- SkillID: 278, 708, 709, 710, Wrath - Attack Damage - (Grow Lancer, Mirage Lancer)
function GrowLancerWrathAttackDamage(Strength, Dexterity)
	local AttackMin = Strength / 8 + Dexterity / 10
	local AttackMax = Strength / 4 + Dexterity / 6
...
-- SkillID: 272, Circle Shield - (Grow Lancer, Mirage Lancer)
function GrowLancerCircleShield(Strength, Dexterity, Energy)
...
-- SkillID: X, Hemorrhage - (IGC_BuffEffectManager.xml -> Index: 239)
...
-- SkillID: X, Paralysis - (IGC_BuffEffectManager.xml -> Index: 240)
...
-- SkillID: X, Bondage - (IGC_BuffEffectManager.xml -> Index: 241)
...
-- SkillID: X, Blindness - (IGC_BuffEffectManager.xml -> Index: 242)
