...
-- ====================================================================
	...
	AddItemBag(BAG_COMMON, MakeItemID(14,248),0, 'Item_(14,248,0)_Minor_Evomon_Box') -- DropFunction /1/
	AddItemBag(BAG_COMMON, MakeItemID(14,249),0, 'Item_(14,249,0)_Standard_Evomon_Box') -- DropFunction /1/
	AddItemBag(BAG_COMMON, MakeItemID(14,250),0, 'Item_(14,250,0)_Greater_Evomon_Box') -- DropFunction /1/
	AddItemBag(BAG_COMMON, MakeItemID(14,251),0, 'Item_(14,251,0)_Luxurious_Evomon_Box') -- DropFunction /1/
	AddItemBag(BAG_COMMON, MakeItemID(14,252),0, 'Item_(14,252,0)_Magnificent_Evomon_Box') -- DropFunction /1/
	AddItemBag(BAG_COMMON, MakeItemID(14,253),0, 'Item_(14,253,0)_Legendary_Evomon_Box') -- DropFunction /1/
	...
	AddItemBag(BAG_COMMON, MakeItemID(14,265),0, 'Item_(14,265,0)_Goblin_Treasure_Box_(Green)') -- DropFunction /1/
	AddItemBag(BAG_COMMON, MakeItemID(14,266),0, 'Item_(14,266,0)_Goblin_Treasure_Box_(Blue)') -- DropFunction /1/
	AddItemBag(BAG_COMMON, MakeItemID(14,267),0, 'Item_(14,267,0)_Goblin_Treasure_Box_(Red)') -- DropFunction /1/
	AddItemBag(BAG_COMMON, MakeItemID(14,268),0, 'Item_(14,268,0)_Goblin_Treasure_Box_(Yellow)') -- DropFunction /1/
	AddItemBag(BAG_COMMON, MakeItemID(14,262),0, 'Item_(14,262,0)_Guardman_Captains_Box') -- DropFunction /1/
	AddItemBag(BAG_COMMON, MakeItemID(14,286),0, 'Item_(14,286,0)_Pentagram_Box') -- DropFunction /1/
...
-- ====================================================================
	...
	AddItemBag(BAG_MONSTER, 0, 691,'Monster_(691)_New_Year_Horse_Green') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 0, 692,'Monster_(692)_New_Year_Horse_Yellow') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 0, 693,'Monster_(693)_New_Year_Horse_Brown') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 0, 694,'Monster_(694)_New_Year_Horse_Blue') -- DropFunction /2/
	AddItemBag(BAG_MONSTER, 0, 716,'Monster_(716)_Core_Magriffy') -- DropFunction /2/
