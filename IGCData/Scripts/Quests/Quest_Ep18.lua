...
function Ep18_Progress(SelectSyntactic, objIndex)
	...
	elseif QS == 3 then
		if SelectSyntactic == 1 then -- 수락 
			...
			if CharClass == CLASS_KNIGHT or CharClass == CLASS_MAGUMSA or CharClass == CLASS_DARKLORD or CharClass == CLASS_MONK or CharClass == CLASS_GROWLANCER then--흑기사, 마검사, 다크로드
	...
	elseif QS == 15 then
		if SelectSyntactic == 1 then -- 수락 
			...
			if CharClass == CLASS_KNIGHT or CharClass == CLASS_MAGUMSA or CharClass == CLASS_DARKLORD or CharClass == CLASS_ELF or CharClass == CLASS_MONK or CharClass == CLASS_GROWLANCER then--흑기사, 마검사, 다크로드, 엘프
